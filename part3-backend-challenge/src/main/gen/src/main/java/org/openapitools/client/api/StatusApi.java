...
public class StatusApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> status 200 response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call statusCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v1/status";
    ...
    public Map<String, Object> status() throws ApiException {
        ApiResponse<Map<String, Object>> localVarResp = statusWithHttpInfo();
     ...
     */
    public ApiResponse<Map<String, Object>> statusWithHttpInfo() throws ApiException {
    ...
    /**
     * API status check (asynchronously)
     * Returns the status of the API
     ...
     */
    public okhttp3.Call statusAsync(final ApiCallback<Map<String, Object>> _callback) throws ApiException {
